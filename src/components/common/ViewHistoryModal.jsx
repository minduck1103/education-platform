  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="2xl">
      <div className="bg-gradient-to-b from-ocean-50 to-white">
        {/* Header */}
        <div className="bg-gradient-to-r from-ocean-600 via-ocean-700 to-ocean-800 px-8 py-6 text-white">
        ...
        <div className="p-8">
          {loading ? (
            ...
            <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-2 view-history-scroll">
